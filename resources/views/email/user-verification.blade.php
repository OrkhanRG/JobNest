...
<head>
    ...
    <title>Hesabın Doğrulanması</title>
    <style>
        body {
...
<div class="email-container">
    ...
    <div class="content">
        ...
        <p>Hesabınızı təsdiqləmək üçün aşağıdakı düyməni klikləyin:</p>
        <p><a href="{{ route('user.verify', $token) }}" class="btn">Hesabı Təsdiqlə</a></p>
