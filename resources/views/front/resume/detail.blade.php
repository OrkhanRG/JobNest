            ...
            <div class="row candidate-profile">
                ...
                <div class="col-md-12">
                    <div class="profile-photo">
                        <img src="{{ asset('assets/images/clients/client1.jpg') }}" class="img-responsive" alt="">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row portfolio-grid mt40">
                ...
                <div class="element col-md-4 col-sm-6 col-xs-6 portfolio-cat1">
                    <figure>
                        <a href="{{ asset('assets/images/portfolio/image1.jpg') }}" class="hover-zoom">
                            <img src="{{ asset('assets/images/portfolio/image1.jpg') }}" class="img-responsive" alt="">
                        </a>
                    </figure>
                </div>
                ...
                <div class="element col-md-4 col-sm-6 col-xs-6 portfolio-cat2">
                    <figure>
                        <a href="{{ asset('assets/images/portfolio/image2.jpg') }}" class="hover-zoom">
                            <img src="{{ asset('assets/images/portfolio/image2.jpg') }}" class="img-responsive" alt="">
                        </a>
                    </figure>
                </div>
                ...
                <div class="element col-md-4 col-sm-6 col-xs-6 portfolio-cat3">
                    <figure>
                        <a href="{{ asset('assets/images/portfolio/image3.jpg') }}" class="hover-zoom">
                            <img src="{{ asset('assets/images/portfolio/image3.jpg') }}" class="img-responsive" alt="">
                        </a>
                    </figure>
                </div>
                ...
                <div class="element col-md-4 col-sm-6 col-xs-6 portfolio-cat4">
                    <figure>
                        <a href="{{ asset('assets/images/portfolio/image4.jpg') }}" class="hover-zoom">
                            <img src="{{ asset('assets/images/portfolio/image4.jpg') }}" class="img-responsive" alt="">
                        </a>
                    </figure>
                </div>
                ...
                <div class="element col-md-4 col-sm-6 col-xs-6 portfolio-cat1">
                    <figure>
                        <a href="{{ asset('assets/images/portfolio/image5.jpg') }}" class="hover-zoom">
                            <img src="{{ asset('assets/images/portfolio/image5.jpg') }}" class="img-responsive" alt="">
                        </a>
                    </figure>
                </div>
                ...
                <div class="element col-md-4 col-sm-6 col-xs-6 portfolio-cat2">
                    <figure>
                        <a href="{{ asset('assets/images/portfolio/image6.jpg') }}" class="hover-zoom">
                            <img src="{{ asset('assets/images/portfolio/image6.jpg') }}" class="img-responsive" alt="">
                        </a>
                    </figure>
                </div>
